...
for i in range(50):
    ...
    Tlf = fake.unique.phone_number()[-9:]
...
# Crea TipusDia per cada Treballador per a 100 dies aleatoris
...
# Crear instancias de Servei
# serveis = []
# for i in range(800):
#     carrer = fake.street_name()
#     numero = random.randint(1, 100)
#     dia = random.choice(DiaTreball.objects.all())
#     servei = Servei.objects.create(Carrer=carrer, Numero=numero, Dia=dia)
#     num_treballadors = random.randint(3, 5)
#     servei.treballadors.set(random.sample(treballadors, num_treballadors))
...
# # print("Indicando si los serveis son especials o quotidians")

# # # Crear instancias de Especial y Quotidia
# # for servei in serveis:
# #     tipus_servei = random.choice([Especial, Quotidia])
# #     if tipus_servei == Especial:
# #         profunditat = random.randint(1, 4)
# #         tipus_servei.objects.create(profunditat=profunditat, servei_ptr=servei)
# #     else:
# #         altura = random.randint(1, 7)
# #         tipus_servei.objects.create(altura=altura, servei_ptr=servei)
